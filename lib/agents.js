...
export function sourceRules() {
  return {
    ...
    communityEditorialRules: [
      'Community Press Voices is part of the 100-year center feature. Search first for direct coverage, editorial reaction, consequences, stakes, local impact, or a clearly documented response to the selected y100 national headline.',
      ...
      'If meaningful same-event coverage cannot be verified, an influential community newspaper’s leading exact-date story may appear only as comparisonType="community_lead". A weekly paper’s nearest surviving issue within seven days may be used only with dateRelation="nearest_weekly_issue".',
      ...
      'Keep independent community leads visually and verbally distinct from same-event responses; never imply a reaction that the source does not document.',
