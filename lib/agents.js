...
export function sourceRules() {
  return {
    ...
    communityEditorialRules: [
      'Community Press Voices is part of the 100-year center feature. Search first for direct coverage of the selected y100 national headline, then reporting or commentary on the same documented topic, including consequences, stakes, local impact, or community-specific framing.',
      'A Community Press Voices story in the exact-date issue that covers the y100 headline must preserve the y100 lead eventKey and comparisonType="same_event".',
      'A later weekly report on the lead event, or a different event within the same documented subject, must use comparisonType="same_topic", match the lead topicKey, keep an accurate eventKey, and carry an explicit dateRelation. An adjacent daily issue within two days or nearest weekly issue within seven days may be used.',
      'Before choosing among community newspapers, rank candidates by documented circulation or geographic/subscriber reach in that historical year, then by longevity. Record sourceSelectionBasis="historic_circulation_reach_then_longevity", publicationFounded when known, sourceRankLabel, and a sourceSelectionNote citing the evidence or its limitation.',
      'If neither same-event nor same-topic coverage can be verified, an influential community newspaper’s leading exact-date story may appear only as comparisonType="community_lead", searchOutcome="same_topic_not_verified", and a sourceSelectionNote. A weekly paper’s nearest surviving issue within seven days may be used only with dateRelation="nearest_weekly_issue".',
      'Identify the community most directly implicated by the national lead and search its own in-country or diaspora press before filling broader representative categories.',
      'After the directly implicated community, seek at least one additional minority press perspective on the same event or topic before using independent community leads.',
      'Keep audited independent community leads visually and verbally distinct from same-event and same-topic coverage; never imply a reaction that the source does not document.',
    ...
    searchRules: [
      ...
      'For community presses, search first for coverage, reaction, consequences, or local/community stakes tied to the selected y100 national headline; then identify leading representative community stories using the labeled fallback rules.',
    ],
    ...
    rules: [
      ...
      'For the 100-year center feature, Major American Press establishes the nationally significant event. Black Press and other Community Press Voices serve as same-event lenses when verified; otherwise their own leading stories may appear with explicit community_lead labels.',
      'A missing same-event voice is an honest research result. Never turn an independent community lead into a manufactured response.',
