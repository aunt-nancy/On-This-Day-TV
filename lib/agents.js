export const AGENTS = [
  ...
  { key: 'social_editor', name: 'Social Editor Agent', group: 'social', phase: 'social_creation', priority: 13, automatic: true },
  { key: 'short_form_video', name: 'Short-Form Video Agent', group: 'social', phase: 'social_creation', priority: 14, automatic: true },
  { key: 'engagement_trends', name: 'Engagement & Trends Agent', group: 'social', phase: 'optimization', priority: 15, automatic: true },
  { key: 'social_distribution', name: 'Social Distribution Agent', group: 'social', phase: 'distribution', priority: 16, automatic: true },
];
...
export function computeEditionDate(inputDate) {
  ...
  return {
    ...
    day: date.getUTCDate(),
    currentYear: year,
    // Keep 76 during the current stabilization cycle. The approved post-launch
    // change back to 75 years will be made only after the site is fully operational.
