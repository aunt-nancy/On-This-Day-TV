...
Do not add historical claims. Keep the entire JSON response compact.
Each script must be 90 words or fewer.
Each shot list must contain no more than 5 short items.
