...
MISSION
Find and independently verify ONE strong American newspaper headline/event from the exact historical date in ${eraYear}. This is a broad-source recovery search, not a single-archive lookup.

MANDATORY SEARCH METHOD
1. Search institutional/original newspaper archives first.
2. Search more than one newspaper title before declaring the era empty.
3. If one archive has no issue, immediately move to:
   - other newspapers published on that date;
   - university-run historic newspaper collections;
   - state library / historical society collections;
   - individual newspaper historical archives.
4. Prefer an identifiable original issue/page with a working source URL.

FOR EARLY-REPUBLIC / y200 SEARCHES
Deliberately include older American newspapers and contemporaneous national publications that actually existed in that era, such as:
...
- Richmond Enquirer
- Charleston Courier
- major Baltimore papers of the period
- Savannah papers of the period
- Niles’ Weekly Register for contemporaneous national context when needed

Also search university and institutional digitization projects listed in sourceRules.

FOR y76 / MID-20TH-CENTURY SEARCHES
Search national papers of record AND major credible regional papers, including:
- New York Times
- Washington Post
- Wall Street Journal
...
- other strong metropolitan papers available in institutional archives
...
For early-American press, recognize that the national press system was more fragmented. If no demonstrably national lead exists, choose the most consequential well-supported American story found across the credible newspapers searched.

DO NOT use a routine marriage, society notice, minor municipal item, ordinary local business notice, or filler when stronger verified coverage exists.
Do not invent a newspaper, issue, headline, date, page, archive, or URL.

Return exactly:
{"agent":"side_era_recovery","status":"complete","eraKey":"${eraKey}","verifiedStory":{"eraKey":"${eraKey}","eraYear":${eraYear},"eventKey":"","sourceDesk":"major_press","coverageScope":"national|multi_state|regional|local","nationalImportance":0,"title":"","summary":"","publication":"","city":"","issueDate":"","page":"","archive":"","sourceUrl":"","community":"major_press","language":"English","articleType":"news|editorial|other","confidence":0,"verificationNotes":"","newspapersSearched":[],"archivesSearched":[]},"discrepancies":[]}.

If no reliable story can be verified, set verifiedStory to null and list the newspapers/archives actually searched in discrepancies rather than simply saying nothing was found.`,
    input: JSON.stringify({
      editionDate: context.editionDate,
      month: context.month,
      day: context.day,
