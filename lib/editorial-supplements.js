...
const SUPPLEMENTS={
  '2026-09-04':{
    y200:{
      eraKey:'y200',
      eraYear:1826,
      eventKey:'daily_national_intelligencer_exact_issue_1826_09_04',
      sourceDesk:'major_press',
      comparisonType:'unmatched',
      coverageScope:'national',
      nationalImportance:0.8,
      title:'The National Capital’s News Record for September 4, 1826',
      summary:'This surviving exact-date issue preserves what the Daily National Intelligencer presented to Washington readers. The edition links to the complete newspaper record and does not invent an article headline where the archive text was not reliably machine-readable.',
      publication:'Daily National Intelligencer',
      city:'Washington City',
      issueDate:'1826-09-04',
      page:'1',
      archive:'Library of Congress',
      sourceUrl:'https://www.loc.gov/resource/sn83026172/1826-09-04/ed-1/',
      language:'English',
      articleType:'issue_record',
      dateRelation:'exact_date',
      sourceSelectionBasis:'exact_date_surviving_national_daily_issue',
      sourceRankLabel:'National capital daily • exact issue',
      sourceSelectionNote:'Selected as a surviving exact-date issue of Washington’s nationally influential daily. It is explicitly presented as an issue record, not as a reconstructed or fabricated article headline.',
      confidence:0.99,
    },
  },
  '2026-09-02':{
    ...
    communityTiles:[
      {
        ...
        sourceRankLabel:'Mexican daily • exact issue',
        ...
        title:'Intervention in Mexico',
        englishTitle:'Intervention in Mexico',
        originalTitle:'La intervención en México',
        ...
        page:'1',
        archive:'National Digital Newspaper Library of Mexico',
